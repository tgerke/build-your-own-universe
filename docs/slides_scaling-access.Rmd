...
function connectElements(i, startSocket = 'top', endSocket = 'auto') {
  ...
  start.line = new LeaderLine(start, end, {hide: true})
...
slideshow.on('showSlide', function(slide) {
  ...
  let lineLeaders = thisSlide.querySelectorAll('[class^="leader-start"]')
  if (lineLeaders.length) {
    lineLeaders.forEach(el => el.line.show('draw'))
  }
})
```
...
```{css line3-css, echo=FALSE}
.leader-start-3 {
  top: 25%;
}
```

.remark-code.pa2.gray-4.w-60[
library(moffittverse)<br><br>
use_backend("abc")<br><br>
.leader-end-3.gray-1[samples&nbsp;&nbsp;&nbsp;&nbsp;&lt;-&nbsp;abc_tbl("sample_inventory")]<br>
.gray-1[patients&nbsp;&nbsp;&nbsp;&lt;-&nbsp;abc_tbl("patient")]<br>
.gray-1[sample_ind&nbsp;&lt;-&nbsp;abc_tbl("sample_indicators")]<br><br>
samples&nbsp;%&gt;%&nbsp;<br>
&nbsp;&nbsp;left_join(sample_ind,&nbsp;by&nbsp;=&nbsp;"SAMPLE_ID")&nbsp;%&gt;%&nbsp;<br>
&nbsp;&nbsp;left_join(patients,&nbsp;by&nbsp;=&nbsp;"PERSON_ID")&nbsp;%&gt;%&nbsp;<br>
&nbsp;&nbsp;abc_choice_replace()&nbsp;%&gt;%&nbsp;<br>
...
patients&nbsp;&nbsp;&nbsp;&lt;-&nbsp;abc_tbl("patient")<br>
sample_ind&nbsp;&lt;-&nbsp;abc_tbl("sample_indicators")<br><br>
.gray-1[.red.b[samples]&nbsp;%&gt;%&nbsp;]<br>
.leader-end-4.gray-1[&nbsp;&nbsp;left_join(sample_ind,&nbsp;by&nbsp;=&nbsp;"SAMPLE_ID")&nbsp;%&gt;%&nbsp;]<br>
.gray-1[&nbsp;&nbsp;left_join(.purple.b[patients],&nbsp;by&nbsp;=&nbsp;"PERSON_ID")&nbsp;%&gt;%&nbsp;]<br>
&nbsp;&nbsp;abc_choice_replace()&nbsp;%&gt;%&nbsp;<br>
&nbsp;&nbsp;abs_not_deleted()
]

<div class="leader-start-4 animated-slide fadeIn">Connect<br><span class="red">samples</span> to <span class="purple">patients</span></div>
...
&nbsp;&nbsp;left_join(sample_ind,&nbsp;by&nbsp;=&nbsp;"SAMPLE_ID")&nbsp;%&gt;%&nbsp;<br>
&nbsp;&nbsp;left_join(patients,&nbsp;by&nbsp;=&nbsp;"PERSON_ID")&nbsp;%&gt;%&nbsp;<br>
.gray-1[&nbsp;&nbsp;abc_choice_replace()&nbsp;%&gt;%&nbsp;]<br>
.leader-end-5.gray-1[&nbsp;&nbsp;abs_not_deleted()]
]

<div class="leader-start-5 animated-slide fadeIn">Tedious, annoying,<br>or error prone</div>

```{js line5, echo=FALSE}
(function() {
  let line5 = connectElements(5, 'bottom')
  line5.path = 'arc'
})()
```